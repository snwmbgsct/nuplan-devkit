...
from nuplan.planning.simulation.planner.project2.my_fiss_plus_planner import MyFissPlusPlanner
...
# planner = MyFissPlusPlanner(horizon_seconds=8.0, sampling_time=1, max_velocity=17)
planner = MyFissPlusPlanner(MockAbstractScenario(time_step=1, number_of_future_iterations=8), horizon_seconds=8, sampling_time=1, max_velocity=17)
