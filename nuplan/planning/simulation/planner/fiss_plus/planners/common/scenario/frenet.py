import copy
import numpy as np
from nuplan.planning.simulation.planner.fiss_plus.planners.common.scenario.lane import LaneType
from nuplan.planning.simulation.planner.fiss_plus.planners.common.geometry.math_utils import unifyAngleRange
...
class FrenetState(object):
    ...
    def from_state(self, state: State, polyline: np.ndarray):
        ...
        def find_next_point_idx(state: State, polyline: np.ndarray): #state dim and polyline dim
